...
yum install -y python3.12 python3.12-devel python3.12-pip \
    autoconf cmake wget automake libtool \
    zlib zlib-devel libjpeg libjpeg-devel \
    gcc gcc-c++ gcc-toolset-13 gcc-toolset-13-gcc gcc-toolset-13-gcc-c++ gcc-toolset-13-binutils \
    git unzip zip patch openssl-devel utf8proc tzdata diffutils libffi-devel
